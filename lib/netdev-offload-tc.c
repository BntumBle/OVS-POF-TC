...
static void
11add_ufid_tc_mapping(struct netdev *netdev, const ovs_u128 *ufid,
struct tcf_id *id)
{
...
const struct netdev_flow_api netdev_offload_tc = {
        .type = "linux_tc",
        .flow_flush = netdev_flow_flush,
        .flow_dump_create = netdev_flow_dump_create,
        .flow_dump_destroy = netdev_flow_dump_destroy,
        .flow_dump_next = netdev_flow_dump_next,
        .flow_put = netdev_flow_put,
        .flow_get = netdev_flow_get,
        .flow_del = netdev_flow_del,
        .init_flow_api = netdev_init_flow_api,
};
